...
const NAV_ITEMS = [
  ...
  { href: 'engineer-instructions', label: 'Engineer Instructions', icon: ClipboardList },
  ...
  return (
    <nav className="hidden md:flex flex-col gap-1 w-48 shrink-0 py-1">
      <Link
        ...
        className="flex items-center gap-2 rounded-md px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground transition-colors mb-1"
      >
