...
const ROLE_PROCUREMENT_PERMISSIONS: Record<string, string[]> = {
  master_admin: [
    ...
    ...expand('rfq', ['view', 'create', 'edit', 'submit', 'review', 'approve', 'issue', 'evaluate', 'award']),
    ...expand('quotation', ['view', 'create', 'edit', 'review', 'shortlist', 'award', 'reject']),
  ...
  project_manager: [
    ...
    ...expand('rfq', ['view', 'review', 'approve']),
